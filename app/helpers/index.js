module.exports = function(app,fs,path,_,mongoose){
    ...
    dirAndFiles.forEach(function (file) {
        ...
        exports[file.replace(/\.js$/, '')]=   require(name)(app,fs,path,_,mongoose);
    });
    ...
    directory.forEach(function(folder) {
        ...
        files.forEach(function (file) {
            ...
            data[file.replace(/\.js$/, '')]= require(path.join(__dirname, folder, file.replace(/\.js$/, '')))(app,fs,path,_,mongoose);
        });
        exports[folder]=data;
    });
